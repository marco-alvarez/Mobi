...
public class FragmentGetOffer extends Fragment implements OnClickListener{

    View view;

    public FragmentGetOffer(){
    }
    ...
    public View onCreateView(LayoutInflater inflater,
        ...
        view = inflater.inflate(R.layout.fragment_get_offer, container, false);
    ...
    public void goToGetRideFragment(){
        ...
        FragmentGet newFragment = new FragmentGet();
    ...
    public void goToOfferRideFragment(){
        // Create fragment and give it an argument specifying the article it should show
        FragmentOffer newFragment = new FragmentOffer();
                /*Bundle args = new Bundle();
                args.putInt(ArticleFragment.ARG_POSITION, position);
                newFragment.setArguments(args);*/
